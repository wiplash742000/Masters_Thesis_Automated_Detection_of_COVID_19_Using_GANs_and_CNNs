...
\begin{table}[H]
    ...
    \hline
         ...
         & Number of Epochs\\
         \hline
         Adam with a learning rate of $1e-3$ & Binary CrossEntropy & Accuracy & 16 & 7 & 10\\
         \hline
    \end{tabular}
    }
...
\begin{table}[H]
    ...
    \hline
         ...
         & Test Set Accuracy\\
         \hline
         0.3204  & 0.9231 & 0.6910 & 0.5000 & 0.6985 & 0.46875\\
         \hline
    \end{tabular}
    }
...
\end{table}
    ...
    \hline
         ...
         & Number of Epochs\\
         \hline
         Adam with a learning rate of $1e-3$ & sparse categorical crossentropy & Accuracy & 32 & 663 & 10\\
         \hline
    \end{tabular}
    }
...
\begin{table}[H]
    ...
    \hline
         ...
         & Test Set Accuracy\\
         \hline
         0.2721  & 0.8882 & 0.2749 & 0.8893 & 0.3800 & 0.8434\\
         \hline
    \end{tabular}
    }
...
\begin{table}[H]
    ...
    \hline
         ...
         & Number of Epochs\\
         \hline
         RMSprop with a learning rate of $10^{-3}$ and a momentum of $10^{-3}$ & binary crossentropy & Accuracy & 32 & 177 & 10\\
         \hline
    \end{tabular}
    }
...
\begin{table}[H]
    ...
    \hline
         ...
         & Test Set Accuracy\\
         \hline
         0.2212 & 0.9018 & 0.5822 & 0.8012 & 0.3574 & 0.8318\\
         \hline
    \end{tabular}
    }
...
\begin{table}[H]
    ...
    \hline
         ...
         & Test Set Accuracy\\
         \hline
         0.1948 & 0.9280 & 0.5361 & 0.7420 & 0.3203 & 0.8697\\
         \hline
    \end{tabular}
    }
...
\end{figure}
\subsection{Evaluation of TL models for Chest X-Ray Dataset}
...
\begin{table}[H]
    ...
    \hline
         ...
         & Number of Epochs\\
         \hline
         256 & RMSPROP & RMSPROP & $1 \times 10 ^ -5$ & $1 \times 10 ^ -5$ & 0 & 0 & 452 & 8 & 100\\
         \hline
    \end{tabular}
    }
...
\begin{table}[H]
    ...
    \hline
         ...
         & Number of Epochs\\
         \hline
         128 & RMSPROP & RMSPROP & $1 \times 10 ^ -4$ & $1 \times 10 ^ -4$ & 0 & 0 & 452 & 8 & 100\\
         \hline
    \end{tabular}
    }
...
\begin{table}[H]
    ...
    \hline
         ...
         & Number of Epochs\\
         \hline
         256 & RMSPROP & RMSPROP & $1 \times 10 ^ -4$ & $1 \times 10 ^ -4$ & 0 & 0 & 47 & 2 & 100\\
         \hline
    \end{tabular}
    }
...
\begin{table}[H]
    ...
    \hline
         ...
         & Number of Epochs\\
         \hline
         256 & RMSPROP & RMSPROP & $1 \times 10 ^ {-4}$ & $1 \times 10 ^ {-4}$ & 0 & 0 & 253 & 16 & 100\\
         \hline
    \end{tabular}
    }
...
\begin{table}[H]
    ...
    \hline
         ...
         & Number of Epochs\\
         \hline
         128 & RMSPROP & RMSPROP & $1 \times 10 ^ {-4}$ & $1 \times 10 ^ {-4}$ & 0 & 0 & 85 & 64 & 100\\
         \hline
    \end{tabular}
    }
...
\begin{table}[H]
    ...
    \hline
         ...
         & Number of Epochs\\
         \hline
         256 & RMSPROP & RMSPROP & $1 \times 10 ^ {-4}$ & $1 \times 10 ^ {-4}$ & 0 & 0 & 42 & 64 & 100\\
         \hline
    \end{tabular}
    }
